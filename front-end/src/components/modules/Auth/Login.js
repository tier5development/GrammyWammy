          ...
          <div className="login_container">
            ...
            <div className="login_block">
              <form>
                ...
                <div className="login_signup">
                  ...
                  <a
                    href="#"
                    onClick={(event) => this.OpenSignupLink("optOne", event)}
                  >
                    Sign up
                  </a>
                </div>
            ...
            <div className="footer">
              <p>
                Powered by{" "}
                <a
                  onClick={(event) => this.LinkHandler("optTwo", event)}
                  href="#"
                >
                  GrammyWammy
                </a>{" "}
                and the{" "}
                <a
                  onClick={(event) => this.LinkHandler("optThree", event)}
                  href="#"
                >
                  GrammyWammy Partnership
                </a>
              </p>
              <a
                onClick={(event) => this.LinkHandler("optFour", event)}
                href="#"
              >
                <img src={path} />
              </a>{" "}
              <a
                onClick={(event) => this.LinkHandler("optFive", event)}
                href="#"
              >
                <img src={messanger} />
              </a>
