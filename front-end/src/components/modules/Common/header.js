...
class header extends Component {
  ...
  autoSetting = async (event) => {
    ...
    await SettingServices.updateLoadStatus(payload)
      .then(async (result) => {
        ...
        if (result.data.code == 1) {
          ...
          if (
            ...
            localStorage.getItem("default_message") == 1 &&
            localStorage.getItem("inBackgroundFetching") == "false" &&
            localStorage.getItem("insta_logged_id") == "true"
          ) {
  ...
  render() {
    return (
      <div className="gen_header">
        {this.state.loader && (
          <div className="after_login_refresh">
        ...
        <div className="hBtnWrapper">
          <div className="toogler">
            <label className="switch_box box_1">
              {this.state.autoresponder_status == "1" ||
              this.state.default_message == "1" ? (
                <div>
                  <input
                    type="checkbox"
                    className="switch_1"
          ...
          <div className="slide_menu_click">
            <a href="#" className="side_click" onClick={this.ShowMenu}>
              <img src={sideMenuLogo} />
            </a>
            <div
              className={
                this.state.openNavBar ? "slider_menu active" : "slider_menu"
              }
            >
              <a href="#" onClick={this.HideMenu} className="cross">
                X
              </a>
              ...
              <ul className="menunav">
                <li>
                  <NavLink to="/dashboard">
                    <img src="images/menuicon4.svg" /> Dashboard
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/setting">
                    <img src="images/menuicon3.svg" /> Settings
                  </NavLink>
                </li>

                <li>
                  <NavLink to="/logout">
                    <img src="images/menuicon1.svg" /> Logout
                  </NavLink>
                </li>
              </ul>
            </div>
