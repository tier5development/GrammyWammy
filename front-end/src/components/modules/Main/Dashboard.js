...
class Dashboard extends Component {
  ...
  componentDidMount() {
    ...
    AuthServices.userRetrive(params)
      .then((result) => {
        ...
        if (result.data.code === 1) {
          ...
          localStorage.setItem(
            "insta_id",
            responsenewvalue.payload.UserInfo.instagram_fbid
          );
          localStorage.setItem(
            "insta_username",
            ...
            {this.state.is_user_logged_in_facebook === "true" ? (
              ...
              <div className="login_caution">
                <img
                  ...
                  alt=""
                />
                Please login to your Instagram profile and click the refresh
                button below to proceed further.
              </div>
            )}

            <a onClick={this.refreshHandler} href="#" className="bluebtn">
              <img src={RefreshLogo} alt="" /> Refresh
            </a>
            <a onClick={this.instaHandler} href="#" className="whitebtn">
